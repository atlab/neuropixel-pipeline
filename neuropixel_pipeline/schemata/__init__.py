...
class BetterHelper(BaseModel):
    # doing this doesn't actually forward the values to the nested dataclass,
    # so they're not actually accessible or tied to the nested class in any way except nominally.
